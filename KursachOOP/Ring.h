...
{
	cout << setw(18) << "АДРЕС" << setw(15) << "ВЛАДЕЛЕЦ" << setw(10) << "ЦЕНА" << setw(18) << "ЖИЛАЯ ПЛОЩАДЬ" << setw(18) << "ГОД ПОСТРОЙКИ"
		<< setw(10) << "ЭТАЖ" << setw(18) << "КОЛ-ВО КОМНАТ" << setw(15) << "ГАРАНТИЯ" << endl;
...
{
	cout << setw(10) << "АДРЕС" << setw(10) << "ВЛАДЕЛЕЦ" << setw(10) << "ЦЕНА" << setw(10) << "ЖИЛАЯ ПЛОЩАДЬ" << setw(10) << "ГОД ПОСТРОЙКИ"
		<< setw(10) << "ЭТАЖ" << setw(10) << "КОЛ-ВО КОМНАТ" << setw(10) << "ТИП РЕМОНТА" << endl;
...
{
	cout << setw(10) << "АДРЕС" << setw(10) << "ВЛАДЕЛЕЦ" << setw(10) << "ЦЕНА" << setw(10) << "ЖИЛАЯ ПЛОЩАДЬ" << setw(10) << "ГОД ПОСТРОЙКИ"
		<< setw(10) << "КОЛ-ВО ЭТАЖЕЙ" << setw(10) << "ПОСЁЛОК" << endl;
...
{
	cout << setw(10) << "АДРЕС" << setw(10) << "ВЛАДЕЛЕЦ" << setw(10) << "ЦЕНА" << setw(10) << "ЖИЛАЯ ПЛОЩАДЬ" << setw(10) << "ГОД ПОСТРОЙКИ"
		<< setw(10) << "КОЛ-ВО ЭТАЖЕЙ" << setw(18) << "РАССТОЯНИЕ ОТ ГОРОДА" << endl;
...
{
	cout << setw(10) << "АДРЕС" << setw(10) << "ВЛАДЕЛЕЦ" << setw(10) << "ЦЕНА" << setw(18) << "ПЛОЩАДЬ УЧАСТКА" << endl;
